...
- NextAuth v5 beta (credentials, admin-only)
...
# 4. Seed admin user
npm run seed
# Creates: admin@samasangha.org / admin123
...
app/
  ...
  admin/             # CMS dashboard (protected by middleware)
  api/
    auth/            # NextAuth handler
    admin/           # CRUD API routes (auth-gated)
